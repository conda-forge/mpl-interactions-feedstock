...
Once the `conda-forge` channel has been enabled, `mpl-interactions` can be installed with:

```
conda install mpl-interactions
```

It is possible to list all of the versions of `mpl-interactions` available on your platform with:
